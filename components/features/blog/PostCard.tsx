...
export function PostCard({ post, isFirst = false }: PostCardProps) {
  ...
  return (
    <article className="group h-full">
      <Card className="bg-card/50 hover:border-primary/20 h-full gap-0 overflow-hidden border py-0 backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:shadow-lg">
        {post.coverImage && (
